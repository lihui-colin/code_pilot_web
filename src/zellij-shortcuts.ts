...
//
// Touch scrolling is intentionally left to Zellij Web. Zellij 0.44.3 already
// converts vertical touch gestures into terminal mouse-wheel reports; a
// document-level capture handler would prevent that terminal handler from
// receiving normal mobile-browser touch events.
...
export const renderZellijShortcuts = (): string => `
